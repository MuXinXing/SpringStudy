...
<img title="" src="IMG/IOC_2.jpg" alt="" data-align="inline">
...
        p标签简化了<property>的注入方法，使其可以在bean自闭合标签中使用，还是需要依赖Set方法和无参构造的。
